			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-material-outline-business-center"></i> My Text Data Results</h3>
						</div>
						...
						<div class="content">
							<ul class="dashboard-box-list">
								<?php if($total_text != 0) { ?>
									<?php 
										$db->bind("user_id", $_SESSION['user_id']);
										$query = "SELECT diagnosis, time FROM patient_data WHERE user_id = :user_id ORDER BY time DESC";
										$data_text = $db->query($query);
